...
// public EditeurEntity postEditeur(@PathVariable String nom) {
// return editeurService.ajouterEditeur(new EditeurEntity(nom));
// }

// // https://sonarsource.atlassian.net/browse/RSPEC-4684
// @PostMapping("")
// @ResponseStatus(code = HttpStatus.CREATED)
// public EditeurEntity postEditeur(@RequestBody EditeurEntity editeur) {
...
// @GetMapping("/{id}")
// public EditeurEntity getEditeur(@PathVariable Long id) {
