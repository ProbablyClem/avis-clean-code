...
public class EditeurController {
	...
	/**
	 * Cette méthode traite la requête HTTP qui demande à accéder au formulaire HTML d'ajout d'un éditeur
	 * @return
	 */
	@GetMapping({ "editeur" })
	...
	@PostMapping({ "editeur" })
	public ModelAndView editeurPost(@Valid @ModelAttribute Editeur editeur, BindingResult result) {
		if (result.hasErrors()) {
